 ...
 */
//region your codes 1
interface UserBizAuditLog: IDbEntity<String, io.kuark.ability.sys.provider.user.model.po.UserBizAuditLog> {
//endregion your codes 1

    companion object : DbEntityFactory<io.kuark.ability.sys.provider.user.model.po.UserBizAuditLog>()
