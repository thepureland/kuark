 ...
 */
//region your codes 1
interface UserContactWay: IMaintainableDbEntity<String, io.kuark.ability.sys.provider.user.model.po.UserContactWay> {
//endregion your codes 1

    companion object : DbEntityFactory<io.kuark.ability.sys.provider.user.model.po.UserContactWay>()
