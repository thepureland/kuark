 ...
 */
//region your codes 1
interface UserPersonalInfo: IMaintainableDbEntity<String, io.kuark.ability.sys.provider.user.model.po.UserPersonalInfo> {
//endregion your codes 1

    companion object : DbEntityFactory<io.kuark.ability.sys.provider.user.model.po.UserPersonalInfo>()
