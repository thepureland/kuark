...
import io.kuark.ability.sys.provider.user.model.po.UserDbAuditLog
 ...
 */
//region your codes 1
object UserDbAuditLogs: StringIdTable<io.kuark.ability.sys.provider.user.model.po.UserDbAuditLog>("user_db_audit_log") {
