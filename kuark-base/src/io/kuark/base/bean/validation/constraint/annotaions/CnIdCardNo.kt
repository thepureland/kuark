...
import io.kuark.base.bean.validation.constraint.validator.CnIdCardNoValidator
...
annotation class CnIdCardNo(
     ...
     */
    val message: String = "{io.kuark.base.bean.validation.constraint.annotaions.CnIdCardNo.message}",
