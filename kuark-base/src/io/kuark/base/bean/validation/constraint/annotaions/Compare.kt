...
import io.kuark.base.bean.validation.constraint.validator.CompareValidator
...
annotation class Compare(
    ...
    /** 比较的逻辑 */
    val logic: LogicOperator = LogicOperator.EQ,
     ...
     */
    val message: String = "{io.kuark.base.bean.validation.constraint.annotaions.Compare.message}",
