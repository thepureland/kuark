...
import io.kuark.base.bean.validation.constraint.validator.CustomValidator
...
annotation class Custom(
     ...
     */
    val message: String = "{io.kuark.base.bean.validation.constraint.annotaions.Custom.message}",
