...
import io.kuark.base.bean.validation.constraint.validator.ExistValidator
...
annotation class Exist(
     ...
     */
    val message: String = "io.kuark.base.bean.validation.constraint.annotaions.Any.message",
