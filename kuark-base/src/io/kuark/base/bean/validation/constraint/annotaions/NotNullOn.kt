...
import io.kuark.base.bean.validation.constraint.validator.NotNullOnValidator
...
annotation class NotNullOn(
     ...
     */
    val message: String = "{io.kuark.base.bean.validation.constraint.annotaions.NotNullOn.message}",
