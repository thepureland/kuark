...
import io.kuark.base.bean.validation.constraint.validator.SeriesValidator
...
annotation class Series(
     ...
     */
    val message: String = "{io.kuark.base.bean.validation.constraint.annotaions.Series.message}",
