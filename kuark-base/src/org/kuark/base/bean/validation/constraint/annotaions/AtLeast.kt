...
import org.kuark.base.bean.validation.constraint.validator.AtLeastValidator
...
annotation class AtLeast(
     ...
     */
    val message: String = "{org.kuark.base.bean.validation.constraint.annotaions.AtLeast.message}",
