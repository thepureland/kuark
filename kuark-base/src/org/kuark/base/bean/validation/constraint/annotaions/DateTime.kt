...
import org.kuark.base.bean.validation.constraint.validator.DateTimeValidator
...
annotation class DateTime(
     ...
     */
    val message: String = "{org.kuark.base.bean.validation.constraint.annotaions.DateTime.message}",
