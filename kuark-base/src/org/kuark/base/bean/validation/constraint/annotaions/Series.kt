...
import org.kuark.base.bean.validation.constraint.validator.SeriesValidator
...
annotation class Series(
     ...
     */
    val message: String = "{org.kuark.base.bean.validation.constraint.annotaions.Series.message}",
