...
internal class GroupValidationTest {
    ...
    internal data class TestGroupSequenceProviderBean(
        ...
        class GroupSequenceProvider : DefaultGroupSequenceProvider<TestGroupSequenceProviderBean> {

            override fun getValidationGroups(bean: TestGroupSequenceProviderBean?): MutableList<Class<*>> {
