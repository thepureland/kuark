...
import org.kuark.demo.tools.codegen.biz.CodeGenFileBiz
import org.kuark.demo.tools.codegen.biz.CodeGenObjectBiz
import org.kuark.demo.tools.codegen.core.merge.CodeMerger
import org.kuark.demo.tools.codegen.core.merge.PrivateContentEraser
import org.kuark.demo.tools.codegen.model.vo.GenFile
import java.io.File
import java.net.URL
...
class CodeGenerator(
    ...
    private fun persistence(): Boolean {
        ...
        if (success) {
            success = org.kuark.demo.tools.codegen.biz.CodeGenColumnBiz.saveColumns()
            if (success) {
