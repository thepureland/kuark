...
import io.kuark.service.auth.provider.rbac.model.table.AuthUserAccountThirdPartys
...
@Repository
//region your codes 1
open class AuthUserAccountThirdPartyDao : BaseCrudDao<String, AuthUserAccountThirdParty, AuthUserAccountThirdPartys>() {
